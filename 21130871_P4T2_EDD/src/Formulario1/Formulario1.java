...
public class Formulario1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        if(!stack.pilaVacia()){
            int contador = stack.getTope();
            modelo.setRowCount(stack.getTope());
            PilaArray<Dato> auxStack = new PilaArray(stack.getTope());
            Dato oDato = new Dato();
